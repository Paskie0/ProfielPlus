...
<head>
    ...
    <script src="../views/partials/scroll.js"></script>
</head>
                ...
                <li>
                    ...
                    <div>
                        <form method="post" action="../updateProfileData.php" enctype="multipart/form-data">
                            ...
                            <div></div>
                            <input type="file" accept="image/jpeg" name="pfp" id="file">
                            <div></div>
                ...
                <li>
                    ...
                    <div>
                        <form method="post" action="../updateProfileData.php">
                            ...
                            <div>*</div>
                            <input type="number" min="1" step="1" max="5" placeholder="Add skill level 1 to 5" name="skill_level">
                            <div>*</div>
